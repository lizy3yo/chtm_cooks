<script lang="ts">
	...
	// Only render on instructor routes
	...
	<div class="flex items-center gap-2">
		...
		<div class="flex items-center gap-2 lg:hidden">
			...
			<div class="leading-tight">
				<p class="text-xs font-bold text-gray-900">Instructor</p>
			...
			{#if notifOpen}
				...
				>
					<div class="flex items-center justify-between border-b border-gray-100 px-4 py-3">
						...
						<a href="/instructor/notifications" onclick={() => notifOpen = false} class="text-xs font-medium text-pink-600 hover:text-pink-700">View all</a>
					</div>
			...
			<div class="relative" data-topnav-dropdown>
				...
				{#if profileOpen}
					...
					>
						...
						<a href="/instructor/account/profile" onclick={() => profileOpen = false} role="menuitem" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-pink-50 hover:text-pink-600">
							<User size={15} class="text-gray-400" /> Profile
						</a>
						<a href="/instructor/account/settings" onclick={() => profileOpen = false} role="menuitem" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-pink-50 hover:text-pink-600">
							<Settings size={15} class="text-gray-400" /> Settings
						</a>
						<a href="/instructor/account/history" onclick={() => profileOpen = false} role="menuitem" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-pink-50 hover:text-pink-600">
