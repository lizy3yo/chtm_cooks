...
export const GET: RequestHandler = async (event) => {
    ...
    try {
        ...
        const response = {
            ...
            inventory: { summary: { currentCount: 0, eomCount: 0, variance: 0, donations: 0, requiredCount: 0, lowStockCount: 0, stockAdjustmentsAdded: 0, stockAdjustmentsDeducted: 0, stockAdjustmentsCount: 0 }, requiredItems: [], mostBorrowedItems: [], itemsCurrentlyOut: [], damageRateItems: [], eomVariance: [], varianceDrivers: [], stockAlerts: [], stockAdjustments: [] },
