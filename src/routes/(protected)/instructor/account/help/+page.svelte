<script lang="ts">
	...
	const faqs = [
		...
		{ question: 'How do I return borrowed items?', answer: 'Go to "My Borrowed Items", find the active loan, and click "Initiate Return". The custodian will inspect the items and confirm the return on their end.' },
		{ question: 'Why was my request rejected?', answer: 'Requests can be rejected by your instructor or the custodian. Common reasons include insufficient stock, invalid dates, or missing class enrollment. Check the rejection reason in "My Requests" for details.' },
