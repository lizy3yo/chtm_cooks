<script lang="ts">
	...
	import { Bell, CheckCheck, ListFilter } from 'lucide-svelte';
...
<svelte:head>
	<title>Notifications - Account - Student Portal</title>
</svelte:head>

<div class="space-y-6">
	<div class="border-b border-gray-200 pb-5">
		<h1 class="text-3xl font-bold text-gray-900">Notifications</h1>
		<p class="mt-2 text-sm text-gray-600">Track updates on approvals, pickups, returns, and item issues</p>
	</div>
		...
		<div class="flex flex-col items-center justify-center rounded-xl border border-gray-200 bg-white p-16 text-center shadow-sm">
			...
			<p class="mt-2 max-w-sm text-sm text-gray-500">
				{filter === 'unread' 
					...
					: "You will see request lifecycle updates here as they happen."}
			</p>
		</div>
	{:else}
		<div class="space-y-3">
